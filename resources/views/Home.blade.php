	      ...
	      <div class="slider-item ">
	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url({{asset("imgs/p-removebg.png")}});">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Hello!</span>
			            <h1 class="mb-4 mt-3">I'm <span>Fady Gamil</span></h1>
			            <h2 class="mb-4">A Full-Stack Web Developer , Data analyst</h2>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url({{asset('imgs/aboutMeImg.jpg')}});">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>Dedicated Junior Full Stack Web Developer with a passion for creating dynamic and  user-friendly web applications. Seeking to leverage my skills to work on exciting projects  and grow as a developer</p>
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>Fady Gamil Hana</span></li>
		            	<li class="d-flex"><span>Date of birth:</span> <span>Feb 12, 2002</span></li>
		            	<li class="d-flex"><span>Address:</span> <span>King Faisal St - Giza</span></li>
		            	<li class="d-flex"><span>Email:</span> <span>fadygamilha@gmail.com</span></li>
		            	<li class="d-flex"><span>Phone: </span> <span>+(20)1279792658</span></li>
		            </ul>
		          </div>
		        </div>
